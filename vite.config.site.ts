 ...
 *
 * Separate from `vite.config.ts`, which builds the Lit component as a library
 * to `./dist/`. This config builds `index.html` into `./site/cad-nauseam/` so
 * the output mirrors the Cloudflare route (`frontiernerds.com/cad-nauseam*`) —
